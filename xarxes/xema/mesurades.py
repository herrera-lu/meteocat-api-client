...
class Mesurades:
    def mesurades_x_1_variable_d_totes_estacions_o_1_estacio(
        self, codi_variable: str, any: int, mes: int, dia: int, codi_estacio: str = None
    ) -> dict:
        """
        ...
        Args:
            codi_variable (str): Codi de l'estació a consultar.
            any (int): 	Codi de la variable a consultar.
            mes (int): Any de consulta en format numèric YYYY.
            dia (int): Mes de consulta en format numèric MM.
            codi_estacio (str, optional): Dia de consulta en format numèric DD. Per defecte None.
    ...
    def mesurades_x_ultimes_dades_1_variable_d_totes_estacions(
    ...
    def mesurades_metadades_x_1_variable(self, codi_variable: str) -> dict:
        """
