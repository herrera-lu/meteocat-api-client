...
class Estadistics:
    def estadistics_anuals_x_1_variable_d_totes_estacions(
        self, codi_variable: str, codi_estacio: str = None
        ...
        Args:
            codi_variable (str): Codi de la variable a consultar.
    ...
    def estadistics_mensuals_x_1_variable_d_totes_estacions(
        self, codi_variable: str, any: int, codi_estacio: str = None
    ) -> Union[dict, List[dict]]:
        """
    ...
    def estadistics_diaris_x_1_variable_d_totes_estacions(
        self, codi_variable: str, any: int, mes: int, codi_estacio: str = None
    ) -> Union[dict, List[dict]]:
        """
    ...
    def estadistics_metadades_estadistics_anuals(self) -> List[dict]:
        """
    ...
    def estadistics_metadades_estadistics_anuals_x_1_variable(
        self, codi_variable: str
    ) -> dict:
        """
        Retorna les metadades dels estadístics anuals per la variable seleccionada.

        Args:
            codi_variable (str): Codi identificatiu de la variable que es vol consultar.
    ...
    def estadistics_metadades_estadistics_mensuals(self) -> List[dict]:
        """
    ...
    def estadistics_metadades_estadistics_mensuals_x_1_variable(
        self, codi_variable: str
    ) -> dict:
        """
    ...
    def estadistics_metadades_estadistics_diaris(self) -> List[dict]:
        """
    ...
    def estadistics_metadades_estadistics_diaris_x_1_variable(
        self, codi_variable: str
    ) -> dict:
        """
    ...
    def estadistics_metadades_estadistics_anuals_d_1_estacio(
    ...
    def estadistics_metadades_estadistics_anuals_x_1_variable_d_1_estacio(
        self, codi_estacio: str, codi_variable: str
    ) -> dict:
        """
    ...
    def estadistics_metadades_estadistics_mensuals_d_1_estacio(
        self, codi_estacio: str
    ) -> List[dict]:
        """
    ...
    def estadistics_metadades_estadistics_mensuals_x_1_variable_d_1_estacio(
        self, codi_estacio: str, codi_variable: str
    ) -> dict:
        """
    ...
    def estadistics_metadades_estadistics_diaris_d_1_estacio(
        self, codi_estacio: str
    ) -> List[dict]:
        """
    ...
    def estadistics_metadades_estadistics_diaris_x_1_variable_d_1_estacio(
        self, codi_estacio: str, codi_variable: str
    ) -> dict:
        """
        Retorna les metadades dels estadístics mensuals d'una variable mesurada en una estació concreta.
